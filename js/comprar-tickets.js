...
const valorTicketConsulta = 1000;

// Defino porcentajes de descuento según categoría
let descuentoContado = 20;
let descuentoCuotas   = 10;
let descuentoDolares    = 30;
...
function total_a_pagar() {
    ...
    let totalvalorTicketConsultas = (cantidadTickets.value) * valorTicketConsulta;

    // Aplico descuentos según categoría
    if (categoria.value == 0) {
        totalvalorTicketConsultas = totalvalorTicketConsultas ;
    }
    if (categoria.value == 1) {
        totalvalorTicketConsultas = totalvalorTicketConsultas - (descuentoContado / 100 * totalvalorTicketConsultas);
    }
    if (categoria.value == 2) {
        totalvalorTicketConsultas = totalvalorTicketConsultas - (descuentoCuotas/ 100 * totalvalorTicketConsultas);
    }
    if (categoria.value == 3) {
        totalvalorTicketConsultas = totalvalorTicketConsultas - (descuentoDolares/ 100 * totalvalorTicketConsultas);
    }

    // Inserto el valor en el HTML
    totalPago.innerHTML = totalvalorTicketConsultas;
}
